# QChi
Software used at work "QChi: a faster classification algorithm based on Wang-Mendel algorithm"
...
`QChi -e <path/seed problem> [-LearningModel <num>] [-InferenceModel <num>] [Parameters]`
...
* * `1` AUC (Only valid for two classes)
* * `2` Geometric Mean (GM)
...
##### ./QChi -e ../data/texture/texture -nlabel 5
...
##### ./QChi -e ../data/census/census -IM 4 -nlabel 5 -maxrules 1024
...
##### ./QChi -e ../data/satimage/satimage -LM 2 -times 5 -nlabel 3 -maxrules 1024 -size 1000000 
