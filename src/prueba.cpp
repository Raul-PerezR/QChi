...
void DescripcionExperimento(const ProgramParameters &InputParam)
{
	...
	if (InputParam.Nit)
		...
		cout << "Non-Activated ";
	cout << "Inference real on Training Set" << endl;
	if (InputParam.NormalizedMu)
		cout << "Normalized Adaptation Used" << endl;
}
...
vector<vector<double>> CalculoEstimadoSobrePatronesConNEtiquetas(int nlabels, example_set &E, const VectorVar &V, int num_par, ProgramParameters InputParam)
{
	...
	for (int i = 0; i < V.N_Antecedente(); i++)
	{
		...
		{ // Mantener las discretas como discretas
...
{
	cout << "Sintax:\n";
	cout << "\tQChi -e <path/seed problem> [-LearningModel <num>] [-InferenceModel <num>] [Parameters] \n";
	cout << "\nParameters Basic: \n";
	...
	cout << "\t\t1\tBasic QChi Algorithm. Selected by default\n";
